...
6. `internal/runtime/probe/probe.go:21-24` ganha `"codex": ".specs/adr/013-codex-cli-acp-native.md"` em `adrByID`.
...
- ADR-012 — `.specs/adr/012-copilot-cli-acp-native.md` (precedente direto F1-Copilot)
