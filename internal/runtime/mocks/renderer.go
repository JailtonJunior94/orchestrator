...
// Render provides a mock function with given fields: evt
func (_m *Renderer) Render(evt events.Event) {
	_m.Called(evt)
}
...
func (_c *Renderer_Render_Call) RunAndReturn(run func(events.Event)) *Renderer_Render_Call {
	_c.Run(run)
	return _c
}
