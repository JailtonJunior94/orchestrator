...
6. `internal/runtime/probe/probe.go:21-24` adiciona `"codex": "tasks/adr/013-codex-cli-acp-native.md"` em `adrByID`.
...
- `tasks/adr/013-codex-cli-acp-native.md` — **já entregue** declarando decisão F1-Codex.
...
- `internal/runtime/probe/probe.go:21-24` — Adicionar `"codex": "tasks/adr/013-codex-cli-acp-native.md"` em `adrByID`.
...
- `internal/runtime/probe/probe.go` — Tabela `adrByID["codex"] = "tasks/adr/013-..."`.
...
| T-16 | `probe.adrByID` | Lookup `"codex"` | `adrByID["codex"] == "tasks/adr/013-codex-cli-acp-native.md"` |
...
- ADR-013 já entregue (`tasks/adr/013-codex-cli-acp-native.md`).
...
Cada decisão material abaixo está registrada em ADR-013 ([`tasks/adr/013-codex-cli-acp-native.md`](../adr/013-codex-cli-acp-native.md)):
...
- `tasks/adr/013-codex-cli-acp-native.md` (já entregue)
