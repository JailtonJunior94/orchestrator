...
func newValidateEvidenceCmd() *cobra.Command {
...
Exemplos:
  ...
  ai-spec validate-evidence refactor refactor-report.md`,
	...
	cmd.Flags().StringArrayVar(&validateEvidenceRFIDs, "rf", nil, "ID de requisito para rastreabilidade (repetivel, ex: --rf RF-01 --rf RF-02)")
	return cmd
}
